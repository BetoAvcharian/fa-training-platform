...
export interface ObjectiveForEdit {
  id: string
  category: string
...
export function ObjectiveEditModal({ objective, open, onClose }: { objective: ObjectiveForEdit; open: boolean; onClose: () => void }) {
  ...
  return (
    <Modal open={open} onClose={onClose} title="Editar objetivo">
