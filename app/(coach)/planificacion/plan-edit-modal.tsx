...
/** El formulario de edición en sí — sin trigger propio, para poder abrirlo desde donde haga falta (botón lápiz en la Lista, o al tocar un bloque en el Diagrama). */
export function PlanEditModal({ plan, open, onClose }: { plan: PlanForEdit; open: boolean; onClose: () => void }) {
  ...
  return (
    <Modal open={open} onClose={onClose} title="Editar plan">
